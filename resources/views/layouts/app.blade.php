...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.html"><img src="{{asset('index/img/black_flogo.svg')}}" width="150" alt="Meemoney"></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li class="active open"><a href="{{route('dashboard')}}"><i class="zmdi zmdi-home"></i><span>Главная</span></a></li>
            ...
            <li><a href="/exit.php" class=" waves-effect waves-block"><i class="zmdi zmdi-account"></i><span>Пользователи</span></a></li>

            <li><a href="/exit.php" class=" waves-effect waves-block"><i class="zmdi zmdi-minus-circle"></i><span>Выход</span></a></li>
            <li>
