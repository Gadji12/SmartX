                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-12 py-1">
                                    <p> Все пользователи, которые будут регистрироваться по данной реферальной ссылке, будут являться Вашими партнерами-инвесторами. При условии, если вы проинвестировали более 15.000 RUB в проект(ы), то тем самым Вы активируете партнерскую программу, по которой получаете по 7% с 1-го поколения от суммы инвестированных ими средств в проекты. А также по 3% до 9 поколения *. И это еще не все... Когда инвесторы начнут получать прибыль от действующих проектов, вы будете зарабатывать по 2% до 9-го поколения * от их прибыли.</p>
