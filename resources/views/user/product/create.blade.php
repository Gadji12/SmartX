                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <input type="file" name="user_picture_offer" class="dropify" data-show-errors="true" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="user_offer_name" placeholder="Название проекта" class="form-control">
                                </div>

                                <label for="shortdesc">Описание проекта</label>
                                <div class="form-group">
                                    <textarea rows="4" class="form-control" name="user_desc_offer" id="shortdesc" placeholder="Это описание будут видеть инвесторы"></textarea>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" name="user_price_per_offer" class="form-control" placeholder="1500">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group masked-input mb-3">
                                            ...
                                            <input type="text" name="user_number_shares_offer" class="form-control" placeholder="7">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="body">
                                ...
                                <div class="input-group masked-input">
                                    ...
                                    <input type="text" name="user_end_date_offer" class="form-control date" placeholder="30.07.2016">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <input type="file" name="user_picture_or_file_offer" class="dropify" data-show-errors="true" />
                            </div>
                        </div>
                    </div>
                    <!-- Banners End -->
